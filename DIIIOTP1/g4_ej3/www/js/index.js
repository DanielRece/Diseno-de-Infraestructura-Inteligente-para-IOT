...
function tomarFoto() {
    ...
    var options = {
        ...
        destinationType: Camera.DestinationType.FILE_URI, // FILE_URI para obtener la uri del archivo
        sourceType: Camera.PictureSourceType.CAMERA,
        encodingType: Camera.EncodingType.JPEG, // Formato de imagen, que es JPEG
        targetWidth: 800, // Ancho de la imagen
        targetHeight: 800 // Alto de la imagen
    };
...
function onSuccess(imageURI) {
    ...
    // Se guarda la foto en la galería (esto puede variar según la plataforma)
    cordova.plugins.imagesaver.saveImageToGallery(
        function (success) {
            console.log('Se ha guardado la foto en la galeria: ' + success);
        },
        function (error) {
